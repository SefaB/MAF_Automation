...
WebUI.verifyElementVisible(findTestObject('Alls/Alls_PLP/ul_ClothingDressesTops ShirtsT-ShirtsSkirt (1)'))

WebUI.verifyElementVisible(findTestObject('Alls/Alls_PLP/ul_Shoes And AccessoriesAll ShoesAll (1)'))
