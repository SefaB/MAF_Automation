...
WebUI.verifyElementVisible(findTestObject('Alls/Items added to your bag/button_Name (ascending)'))

WebUI.click(findTestObject('Alls/Items added to your bag/button_Name (ascending)'))
