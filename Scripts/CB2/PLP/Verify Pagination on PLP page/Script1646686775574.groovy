...
WebUI.scrollToElement(findTestObject('CB2/Common/lazy_loading_product1'), 0)

WebUI.scrollToElement(findTestObject('CB2/Common/lazy_loading_product2'), 0)

WebUI.scrollToElement(findTestObject('CB2/Common/lazy_loading_product3'), 0)

WebUI.scrollToElement(findTestObject('CB2/Homepage/our_radar_section'), 0)

WebUI.click(findTestObject('CB2/Common/go_to_top_button'))
