...
WebUI.verifyElementVisible(findTestObject('CB2/Breadcrumbs/home_breadcrumb'))

WebUI.verifyElementVisible(findTestObject('CB2/Breadcrumbs/furniture_breadcrumb'))

WebUI.verifyElementVisible(findTestObject('CB2/Breadcrumbs/office_furniture_breadcrumb'))

WebUI.verifyElementVisible(findTestObject('CB2/Breadcrumbs/office_chairs_breadcrumb'))
