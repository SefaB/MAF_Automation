...
<WebElementEntity>
   ...
   <name>body_ALLSAINTSSearchSaleW</name>
   <tag></tag>
   <elementGuidId>128c02db-5d0d-47b8-90ff-5e890b1cdcee</elementGuidId>
   <selectorCollection>
      <entry>
         <key>CSS</key>
      </entry>
   ...
   <webElementProperties>
      ...
      <name>class</name>
      <type>Main</type>
      <value>xs-up:bgc=body xs-up.fa-times:icon-before=cross state-loading</value>
   </webElementProperties>
   <webElementProperties>
      <isSelected>false</isSelected>
      <matchCondition>equals</matchCondition>
...
SearchSaleWomenWomenClothingDressesTops &amp; ShirtsT-ShirtsSkirts &amp; ShortsSwimwearLeather JacketsJeansTrousers &amp; LeggingsSweatshirts &amp; HoodiesCoats &amp; JacketsKnitwearNational DayShoes And AccessoriesAll ShoesAll AccessoriesFragranceHandbagsCard Holders &amp; WalletsFace MasksShop DressesFree same day delivery for orders before 7PMMenSearchSearch
          ...
          ALLSAINTSSign InWishlistSomething catch your eye?Sign in to see items you may have added using another computer or device.Sign inBag (1)You are in your cart!Sign in to see items you may have added using another computer or device.CHECKOUTENJOY 20% OFF YOUR FIRST PURCHASE - USE CODE HELLO20SHOP NOWHomeHomeShopping Bag Shopping Bag  YOUR SHOPPING BAG (1 items)&lt; BACK TO SHOP Est. Order Total  (with tax):  AED 650.00  PROCEED TO CHECKOUT  ITEM  ITEM  COLOUR  SIZE  Quantity  Price  Total Price  Lee Lace Dress  Selected option is no longer available. Color: BlackBlackSize: XS X XS Selected option is no longer available. Color: BlackBlackSize: XS X XS 1 Size: XS AED 650.00  AED 650.00 You could earn 65 SHARE points on this.I want to become a SHARE member. Join Today Already have an account?Click here to login.Learn more about SHAREPROMOTIONAL CODE:ApplyCart SummarySubtotal (Incl.VAT)AED 650.00 VAT Amount  AED 30.95  Order Total  AED 650.00 * These amounts are towards VAT and to be remitted on customs clearance on behalf of customersor 4 interest-free payments of 162.50 AED Learn more
            new TabbyPromo({
                selector: '#TabbyPromo',
                currency: 'AED',
                price: '650',
                installmentsCount: 4,
                lang: 'en',
            }); PROCEED TO CHECKOUT QUESTION OR SUPPORT?Send us an email to: customercare@allsaints.meWhere a member of our Customer Experience team will be happy to assist you.New to AllSaints? Sign up for 20% off full-price styles in your first order. Email Address  SEND INFORMATIONContact UsReturns &amp; ExchangeShipping and FAQsSize GuideTrack OrderTerms &amp; ConditionsPrivacy PolicySite MapFOLLOW USInstagramCOPYRIGHT © 2021 ALLSAINTS ALL RIGHTS RESERVED*ORDERS BEFORE 7PM
...
&lt;img height=&quot;1&quot; width=&quot;1&quot; style=&quot;display:none&quot; src=&quot;https://www.facebook.com/tr?id=270495503980976&amp;amp;ev=PageView&amp;amp;noscript=1&quot;>
   ...
   <webElementProperties>
      ...
      <name>xpath</name>
      <type>Main</type>
      <value>/html[1]/body[@class=&quot;xs-up:bgc=body xs-up.fa-times:icon-before=cross state-loading&quot;]</value>
   </webElementProperties>
   <webElementXpaths>
      <isSelected>true</isSelected>
      <matchCondition>equals</matchCondition>
